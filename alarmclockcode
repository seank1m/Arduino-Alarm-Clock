...
// Button pin configurations, Left -> Right config from the display
const int btSet = A2; // Button (1) to change time and alarm 
const int btAdj = A1; // Button (2) to step up time / decrease screen brightness 
const int btAlarm = A0; // Button (3) to step down time / activate alarm in home display mode 
